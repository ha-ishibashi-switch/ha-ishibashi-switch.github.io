export default function KaraokeClubForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 p-6 text-white">
      <div className="max-w-4xl mx-auto rounded-3xl border-2 border-cyan-400 bg-black/70 backdrop-blur p-8 shadow-2xl">
        ...
        <div className="bg-red-950 border-2 border-red-400 text-red-300 font-bold rounded-2xl p-4 text-center mb-6">
          ⚠️ 回答締切：8/21
        </div>
        ...
        <form className="space-y-5">
          ...
          <div className="bg-slate-900 border border-slate-400 rounded-2xl p-4">
            ...
            <textarea className="w-full h-24 bg-slate-800 border border-slate-400 rounded-xl p-3" />
          </div>

          <button
            type="button"
            className="w-full py-4 rounded-2xl text-xl font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500"
          >
            🎤 LET'S SING !!
          </button>
        </form>
